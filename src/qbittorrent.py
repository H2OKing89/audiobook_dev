...
def add_torrent_file_with_cookie(
    ...
    try:
        ...
        logger.info("Uploading torrent file to qBittorrent with options: category=%s, tags=%s, paused=%s, autoTMM=%s, contentLayout=%s", category, tags, paused, autoTMM, contentLayout)
