...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('logs/metadata_flow_test.log')
    ]
)
...
class MetadataFlowTester:
    ...
    def test_config_loading(self):
        ...
        try:
            ...
            mam_config = self.coordinator.mam_scraper.base_url
            logging.info(f"✅ MAM base URL: {mam_config}")
    ...
    def test_dry_run_workflow(self):
        ...
        try:
            ...
            for test_case in test_cases:
                ...
                if url and 'myanonamouse.net' in url:
                    logging.info(f"  ✅ Would follow MAM workflow path")
                else:
                    logging.info(f"  ✅ Would follow direct Audible search path")
