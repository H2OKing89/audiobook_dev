...
class TestEndToEndIntegration:
    ...
    def test_metadata_fetch_to_storage_pipeline(self):
        ...
        with patch.dict('os.environ', {'AUTOBRR_TOKEN': 'test_token'}), \
            ...
            assert stored_data['metadata']['title'] == "Storage Test Book"
    ...
    def test_qbittorrent_integration_workflow(self):
        ...
        with patch.dict('os.environ', {'AUTOBRR_TOKEN': 'test_token'}), \
             patch('src.metadata_coordinator.MetadataCoordinator.get_metadata_from_webhook', return_value={"title": "qBittorrent Book"}), \
